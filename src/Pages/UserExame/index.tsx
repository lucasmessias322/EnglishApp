...
import UserExameComponent from "../../components/UserExameComponent";
...
function UserExame({ match }: any) {
  ...
  return (
    <UserExameComponent match={match}/>
    // <C.ExameContain thema={thema}>
    //   <Header
    //     switchButtom={false}
    //     TituloDaPagina={
    //       toogle ? getStorage("currentUserData").memorize[0].titulo : ".."
    //     }
    //     QtdItems={toogle ? dataBaralho.items.length : "..."}
    //   ></Header>
    //   <br /> <br /> <br /> <br /> <br /> <br />
    ...
    //     <div
    //       className="question"
    //       onClick={() => Speak(dataBaralho.items[currentBaralho].question, 0.8)}
    //     >
    //       <div className="play">
